...
public class CommentsActivity extends AppCompatActivity {
    ImageView ivReportProfile;
    ImageView ivReportPicture;
    ImageView ivSubmitComment;
    ImageView ivBack;
    TextView tvToolbarHeader, tvReportName, tvReportDate, tvReportDisasterType, tvReportAddress, tvReportDescription, tvReportCommentCount, tvEmptyViewHeader, tvEmptyViewSubHeader;
    EditText etComment;
    Intent intent;
    ...
    String date, description, disasterType, fullName, profilePicture, reportPicture, reportId, address, comments;
